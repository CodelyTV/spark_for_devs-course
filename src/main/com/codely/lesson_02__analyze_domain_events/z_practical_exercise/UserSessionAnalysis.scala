...
import org.apache.spark.sql.functions.{col, month, round, unix_timestamp}
...
object UserSessionAnalysis extends App {
  ...
  val sessionsFilePath =
    "src/main/com/codely/lesson_02__analyze_domain_events/z_practical_exercise/data/sessions.csv"
  val eventsFilePath =
    "src/main/com/codely/lesson_02__analyze_domain_events/z_practical_exercise/data/events.txt"
