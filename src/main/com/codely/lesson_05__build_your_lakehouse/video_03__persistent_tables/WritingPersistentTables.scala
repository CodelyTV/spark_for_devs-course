package com.codely.lesson_05__build_your_lakehouse.video_03__persistent_tables
...
object WritingPersistentTables extends App {
  ...
  val productPurchasedDF =
    spark.read.json(
      "src/main/com/codely/lesson_05__build_your_lakehouse/video_03__persistent_tables/data/purchasecompleted.json"
    )
