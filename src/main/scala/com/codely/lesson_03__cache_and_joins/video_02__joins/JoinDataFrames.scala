...
private object JoinDataFrames extends App {
  ...
  val productViewedDF = readJson(
    "src/main/scala/com/codely/lesson_03__cache_and_joins/video_02__joins/data/productViewed.json"
  )

  val productAddedDF = readJson(
    "src/main/scala/com/codely/lesson_03__cache_and_joins/video_02__joins/data/addedToCart.json"
  )

  val productPurchasedDF = readJson(
    "src/main/scala/com/codely/lesson_03__cache_and_joins/video_02__joins/data/purchasecompleted.json"
  )
  ...
  val allEventsDF = productViewedDFlatDF
    .join(
      productAddedFlatDF,
      productViewedDFlatDF("userId") === productAddedFlatDF(
        "userId"
