package com.codely.lesson_03__cache_and_joins.video_03__optimizations
...
object Optimizations extends App {
  ...
  val productViewedDF = spark.read
    .json(
      "src/main/scala/com/codely/lesson_03__cache_and_joins/video_03__optimizations/data/productViewed.json"
    )
