...
object JoinsExercise extends App {
  ...
  // 2.
  val usersFilePath =
    "src/main/scala/com/codely/lesson_03__cache_and_joins/z_practical_exercise/data/users.csv"
  val transactionsFilePath =
    "src/main/scala/com/codely/lesson_03__cache_and_joins/z_practical_exercise/data/transactions.csv"
