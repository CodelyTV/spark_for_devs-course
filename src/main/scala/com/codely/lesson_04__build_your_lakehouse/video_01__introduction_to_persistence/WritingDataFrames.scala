package com.codely.lesson_04__build_your_lakehouse.video_01__introduction_to_persistence
...
object WritingDataFrames extends App {
  ...
  val productPurchasedFilePath =
    "src/main/scala/com/codely/lesson_04__build_your_lakehouse/video_01__introduction_to_persistence/data/purchasecompleted.json"
  ...
  val outputBasePath =
    "src/main/scala/com/codely/lesson_04__build_your_lakehouse/video_01__introduction_to_persistence/output/"
  ...
  /*  newData.write
    .format("csv")
    .option("header", "true")
    .save(s"$outputBasePath/csv/")*/ // This will fail
