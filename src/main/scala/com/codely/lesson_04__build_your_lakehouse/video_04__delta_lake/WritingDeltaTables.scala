package com.codely.lesson_04__build_your_lakehouse.video_04__delta_lake
...
object WritingDeltaTables extends App {
  ...
  val productPurchasedDF = spark.read.json(
    "src/main/scala/com/codely/lesson_04__build_your_lakehouse/video_04__delta_lake/data/purchasecompleted.json"
  )
